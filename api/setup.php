...
$tables = [
    ...
    'menu_items' => "CREATE TABLE IF NOT EXISTS `menu_items` (
        ...
        `category`      ENUM('starter','main_course','bread','rice_biryani','dessert','salad','side_dish','water','welcome_drink','breakfast','thali') NOT NULL,
    ...
    'order_items' => "CREATE TABLE IF NOT EXISTS `order_items` (
        ...
        CONSTRAINT `fk_oi_menu`  FOREIGN KEY (`menu_item_id`) REFERENCES `menu_items`(`id`) ON DELETE SET NULL ON UPDATE CASCADE,
